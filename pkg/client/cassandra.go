...
type Cassandra interface {
    ...
    QueryAlarmHistory(org int64, sensor model.SensorRef, from time.Time, to time.Time, maxValue int) []model.TsPair
    QueryAlarmStates(org int64, sensor model.SensorRef) []model.TsPair
